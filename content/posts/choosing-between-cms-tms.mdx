...
Unlike CMS, which is presentation-centric is ideal for managing rich, complex content where the relationship between elements is as important as the elements themselves.

...
Keep in mind that your function will be executed <b>after</b> the user has finished or stopped to do the action (scrolling/resizing/moving). Because <b>during these actions</b> the cooldown period is most likely never passed.
